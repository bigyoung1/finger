...
public class Log extends haxe.lang.HxObject
{
	static
	{
		//line 62 "D:\\haxe\\haxe\\std\\haxe\\Log.hx"
	...
	public Log()
	{
		//line 29 "D:\\haxe\\haxe\\std\\haxe\\Log.hx"
	...
	{
		//line 34 "D:\\haxe\\haxe\\std\\haxe\\Log.hx"
		java.lang.String str = haxe.root.Std.string(v);
		//line 35 "D:\\haxe\\haxe\\std\\haxe\\Log.hx"
		if (( infos == null )) 
		{
			//line 36 "D:\\haxe\\haxe\\std\\haxe\\Log.hx"
			return str;
		}
		
		//line 37 "D:\\haxe\\haxe\\std\\haxe\\Log.hx"
		...
		if (( ((haxe.root.Array) (haxe.lang.Runtime.getField(infos, "customParams", true)) ) != null )) 
		{
			...
			while (( _g < _g1.length ))
			{
				...
				//line 39 "D:\\haxe\\haxe\\std\\haxe\\Log.hx"
				 ++ _g;
				//line 40 "D:\\haxe\\haxe\\std\\haxe\\Log.hx"
				str += ( ", " + haxe.root.Std.string(v1) );
			}
			
		}
		
		//line 41 "D:\\haxe\\haxe\\std\\haxe\\Log.hx"
		return ( ( pstr + ": " ) + str );
	}
