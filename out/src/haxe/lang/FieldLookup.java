...
public class FieldLookup extends haxe.lang.HxObject
{
	...
	public FieldLookup()
	{
		//line 29 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 38 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		int min = 0;
		//line 39 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		int max = length;
		//line 41 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		while (( min < max ))
		{
			//line 42 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
			int mid = ((int) (( ((double) ((( max + min ))) ) / 2 )) );
			//line 43 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
			int classify = hash.compareTo(hashs[mid]);
			//line 44 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
			if (( classify < 0 )) 
			{
				//line 45 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
				max = mid;
			}
			else
			{
				//line 46 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
				if (( classify > 0 )) 
				{
					//line 47 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
					min = ( mid + 1 );
				}
				else
				{
					//line 49 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
					return mid;
				}
		...
		//line 53 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		return  ~ (min) ;
	}
	...
	{
		//line 57 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 58 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = null;
	}
	...
	{
		//line 62 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 63 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = ((double) (0) );
	}
	...
	{
		//line 67 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 68 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = null;
	}
	...
	{
		//line 103 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 106 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		double[] a1 = a;
		//line 106 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		int capacity = a1.length;
		//line 106 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 109 "D:\\haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
